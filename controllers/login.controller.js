...
const jwt = require("jsonwebtoken");// it ony used for unique not for sequirity
...
async function logIn(req, res, next) {
  try {
    ...
    const payload = {
      ...
      // this adminu new customeru yemilewun slemiredan new
      employee_first_name: employee.data.employee_first_name,
      // hi blen smwan behwala lemasgebat yiredanal
    };
